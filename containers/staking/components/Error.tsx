		...
		<>
			<Box sx={{ display: "flex", justifyContent: "center", flexDirection: "column", alignItems: "center", height: "100%" }}>
				<Box sx={{ textAlign: "center", }}>
					...
					<Typography fontSize={14} color="#31373E" fontWeight={500} mt="28px">{error.titleError}</Typography>
				</Box>
			</Box>
			<MarketplaceButton customStyle={{ width: "100%", mt: "auto" }} title={"Try again"} handleOnClick={handleTryAgain} />
		</>
	)
}
