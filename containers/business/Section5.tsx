...
export const Section5 = () => {
	return (
		<Wrap>
			...
			<Details sx={{ '& span': { color: '#FF6D24' }, lineHeight: { xs: "22px", md: "72px" }, marginTop: { xs: "32px", md: "80px" } }}>  <Typography> <span style={{ color: '#FF6D24' }}>Token Burning Events</span> – Burning events occur on a regular basis, initially set at once
per quarter but subject to community vote.
</Typography></Details>
