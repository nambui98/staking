		...
		<Box height={"100%"} width={"100%"} mt={10}>
			...
			{isMobile ? <Section2Old /> : <Wrap sx={{
				...
				<Box data-aos-offset="1000"
					data-aos-duration="1000" data-aos="fade-right" sx={{ position: "absolute", zIndex: 0, top: "30%", right: "100px" }}>
					<img width={"100%"} src={`assets/sec2/bieucam1.png`} style={{ objectFit: "cover" }} alt="" />
				</Box>
				<Box data-aos-offset="1000"
					data-aos-duration="1000" data-aos="fade-left" sx={{ position: "absolute", zIndex: 0, bottom: "0px", left: "-100px" }}>
					<img width={"100%"} src={`assets/sec2/bieucam2.png`} style={{ objectFit: "cover" }} alt="" />
				</Box>
				<Box data-aos-offset="1000"
					data-aos-duration="1000" data-aos="fade-right" sx={{ position: "absolute", zIndex: 0, bottom: "-100px", right: "0px" }}>
