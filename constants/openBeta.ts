...
export const TAB_BODY_PRE_MAINNET = {
  ...
  reward: {
    ...
    tab3: [
      'Run / walk / cycle at least 3km.',
      'Mint shoes at least once.',
      "Transfer all assets from the Spending wallet to the user's wallet, including HEE, BNB, and NFT items, on July 12. No later than 10:00 UTC, July 12, 2022."
    ],
    bodyGetReward: "Rewards will be delivered directly to participants' Spending wallet after the Mainnet launch."
  },
  rules: {
