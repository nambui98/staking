...
export const FILTER = {
  CATEGORY: {
    daily: {image: 'assets/shoes/shoesDaily.png', title: 'Daily'},
    fitness: {image: 'assets/shoes/shoesFit.png', title: 'Fitness'},
    racer: {image: 'assets/shoes/shoesRacer.png', title: 'Racer'},
  },
  RARITY: {
    CLASSIC: 'Classic',
    RARE: 'Rare',
