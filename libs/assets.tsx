...
export const handleApprove = async (
	...
	ethersSigner: any,
	abiDetail: any,
	type?: 'token' | 'box' | 'shoes' | 'fitterPass'
) => {
...
export const handleDeposit = async (
	...
	const res =
		(await type) === 'token'
			...
			: walletContract.depositItem(tokenAddress, parsePrice, email);
	return res;
};

export const handleDepositBnb = async (
	ethersSigner: any,
	email: string,
	amount: string
) => {
...
export const getBalanceShoes = async (
	ethersSigner: any,
	walletAccount: string
) => {
	const shoesContract = new ethers.Contract(
		bftShoeItem.address,
		bftShoeItem.abi,
		ethersSigner
	);
...
export const getListShoes = async (
	ethersSigner: any,
	walletAccount: string
) => {
	const shoesContract = new ethers.Contract(
