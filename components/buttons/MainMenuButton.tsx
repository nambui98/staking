...
export const MainMenuButton: React.FC<IProps> = ({ title, iconLink, active, disabledBtn, sx }) => {
	return (
		<ButtonWrap disabled={disabledBtn} active={active.toString()} variant="contained" sx={sx} startIcon={iconLink && <img src={iconLink} />}>
			{title}
		</ButtonWrap>
	)
}
