...
export const MarketplaceButton: React.FC<IProps> = ({ price, title, handleOnClick, customStyle, disabled = false }) => {
	return (
		<ButtonMarketPlace disabled={disabled} variant="contained" onClick={handleOnClick} sx={customStyle} price={price} >
