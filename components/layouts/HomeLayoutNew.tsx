...
const HomeLayoutNew: React.FC<any> = ({ sxProps, children, headerLandingPage, currentPage, customWhite }) => {
	...
	return (
		<>
			...
			>
				<HomeHeaderNew headerLandingPage={headerLandingPage} currentPage={currentPage} customWhite={customWhite} />
